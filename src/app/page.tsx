...
export const metadata: Metadata = {
  title: "Dimal Maloku - My Smart Portfolio",
};
    ...
    <section className="space-y-16 bg-[url('/background.png')] bg-cover bg-center bg-no-repeat px-1 py-8">
      <section className="grid grid-cols-1 items-center gap-8 sm:grid-cols-2">
        <div className="space-y-3">
          <H1 className="text-center sm:text-start">Hi, I&apos;m Dimal 👋</H1>
          <p className="text-center sm:text-start">
            I&apos;m a full-stack developer from Kosovo who builds cool projects
            such as Ecommerce, Management Systems types, Protofolio and any
            types
          </p>
        </div>
